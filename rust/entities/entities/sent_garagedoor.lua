...
if SERVER then
    ...
    function ENT:Initialize()
        ...
        self.CollisionBug = ents.Create("sent_blocker_wall")
        self.CollisionBug:SetPos(self:GetPos())
        self.CollisionBug:SetAngles(self:GetAngles())
    ...
    function ENT:Think()
        self.CollisionBug:SetPos(self:GetPos() + self:GetUp() * 35 + self:GetRight() * -10)
