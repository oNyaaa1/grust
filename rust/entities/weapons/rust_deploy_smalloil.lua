...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_oilrefinery")
        ...
        ply:RemoveInventoryItem("rust_deploy_smalloil")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/zohart/deployables/small_refinery.mdl")
        end
