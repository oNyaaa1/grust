...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_sleepingbag")
        ...
        ply:RemoveInventoryItem("rust_deploy_doorway_sleepingbag")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/sleeping_bag.mdl")
        end
