...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_re_workbench_three")
        ...
        ply:RemoveInventoryItem("rust_deploy_workbenchlvl3")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/workbench_tier3.mdl")
        end
