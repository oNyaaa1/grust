...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_re_workbench_one")
        ...
        ply:RemoveInventoryItem("rust_deploy_workbenchlvl1")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/workbench_tier1.mdl")
        end
