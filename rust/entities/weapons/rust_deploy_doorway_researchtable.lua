...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_researchtable")
        ...
        ply:RemoveInventoryItem("rust_deploy_doorway_researchtable")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/research_table.mdl")
        end
