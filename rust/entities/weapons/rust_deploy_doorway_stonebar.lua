...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_stonebarricade")
        ...
        ply:RemoveInventoryItem("rust_deploy_doorway_stonebar")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/stone_barricade.mdl")
        end
