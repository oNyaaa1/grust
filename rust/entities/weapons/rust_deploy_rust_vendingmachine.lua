...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_vendingmachine")
        ...
        ply:RemoveInventoryItem("rust_deploy_rust_vendingmachine")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/vending_machine.mdl")
        end
