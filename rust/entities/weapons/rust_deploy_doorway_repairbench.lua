...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_repairbench")
        ...
        ply:RemoveInventoryItem("rust_deploy_doorway_repairbench")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/repair_bench.mdl")
        end
