...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sent_re_workbench_two")
        ...
        ply:RemoveInventoryItem("rust_deploy_workbenchlvl2")
    ...
    function SWEP:GetPreviewEnt()
        if not IsValid(self.PreviewEnt) then
            ...
            self.PreviewEnt:SetModel("models/deployable/workbench_tier2.mdl")
        end
